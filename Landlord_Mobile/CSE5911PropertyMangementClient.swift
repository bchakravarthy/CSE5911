...
public class CSE5911PropertyMangementClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "CSE5911PropertyMangementClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:CSE5911PropertyMangementClient = {
        ...
        return CSE5911PropertyMangementClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = CSE5911PropertyMangementClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `CSE5911PropertyMangementClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> CSE5911PropertyMangementClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         CSE5911PropertyMangementClient.registerClient(withConfiguration: configuration, forKey: "USWest2CSE5911PropertyMangementClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = CSE5911PropertyMangementClient.client(forKey: "USWest2CSE5911PropertyMangementClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(CSE5911PropertyMangementClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> CSE5911PropertyMangementClient {
		objc_sync_enter(self)
		if let client: CSE5911PropertyMangementClient = _serviceClients.object(forKey: key) as? CSE5911PropertyMangementClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			CSE5911PropertyMangementClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! CSE5911PropertyMangementClient;
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func maintenanceExpenseGet() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/maintenance-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func maintenanceExpensePut() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("PUT", urlString: "/maintenance-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func maintenanceExpensePost() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/maintenance-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMaintExpenseGet() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/prop-maint-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMaintExpensePut() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("PUT", urlString: "/prop-maint-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMaintExpensePost() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/prop-maint-expense", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMortgageLoanGet() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/prop-mortgage-loan", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMortgageLoanPut() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("PUT", urlString: "/prop-mortgage-loan", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
    ...
    /*
     ...
     return type: Empty
     */
    public func propMortgageLoanPost() -> AWSTask<Empty> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/prop-mortgage-loan", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
